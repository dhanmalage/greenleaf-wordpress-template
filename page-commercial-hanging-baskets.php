...
<div class="container">
    <div class="row-fluid">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-padding-left no-padding-right">
            <div class="hanging-baskets-bottom-image-wrapper">
               <a href="<?php echo get_permalink( get_page_by_path( 'summer-hanging-baskets' ) ); ?>">
                    <div class="summer-hanging-basket-image" style="background-image: url('<?php echo get_field("summer_image"); ?>')">
                        <h3>Summer Hanging Baskets</h3>
                    </div>
               </a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-padding-left no-padding-right">
            <div class="hanging-baskets-bottom-image-wrapper">
                <a href="<?php echo get_permalink( get_page_by_path( 'winter-hanging-baskets' ) ); ?>">
                    <div class="winter-hanging-basket-image" style="background-image: url('<?php echo get_field("winter_image"); ?>')">
                        <h3>Winter Hanging Baskets</h3>
                    </div>
                </a>
            </div>
        </div>
