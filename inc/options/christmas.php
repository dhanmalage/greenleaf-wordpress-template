...
Redux::setSection(
    ...
    array( // This is your arguments array
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'christmas_video_id',
                'type'     => 'text',
                'title'    => __('Christmas Page Video ID', 'greenleaf_theme_options'),
                'subtitle' => __('This is the video display on christmas page background.', 'greenleaf_theme_options'),
                'desc'     => __('Plese enter the last part of youtube video url', 'greenleaf_theme_options'),
                'default'  => '00sp4rYqVVw'
            ),
			
			array(
                'id'       => 'christmas_video_poster_image',
                'type'     => 'media',
                'url'      => true,
			...
			array(
                'id'       => 'christmas_video_mobile_image',
                'type'     => 'media',
                'url'      => true,
			...
			array(
				'id'        => 'christmas_video_filter',
				'type'      => 'color_rgba',
				'title'     => 'Christmas Video Color Filter',
            ...
            /* ********* Slide 1 start ********* */
            array(
                'id' => 'christmas-slide1-section-start',
                'type' => 'section',
            ...
            array(
                'id'     => 'christmas-slide1-section-end',
                'type'   => 'section',
                'indent' => false,
            ),
            /* ********* Slide 1 end ********* */
            ...
            /* ********* Slide 2 start ********* */
            array(
                'id' => 'christmas-slide2-section-start',
                'type' => 'section',
            ...
            array(
                'id'       => 'christmas_slide2_tab',
                'type'     => 'text',
                'title'    => __('Tab Text for slide 2', 'greenleaf_theme_options'),
                'default'  => 'Bespoke Christmas displays'
            ),
            array(
                'id'       => 'christmas_slide2_title_small',
                'type'     => 'text',
                'title'    => __('Small Title for slide 2', 'greenleaf_theme_options'),
                'default'  => 'Bespoke Christmas displays'
            ),
            array(
                'id'       => 'christmas_slide2_title1',
                'type'     => 'text',
                'title'    => __('Main Title Line 1', 'greenleaf_theme_options'),
                'default'  => 'NEW SUMMER'
            ),
            array(
                'id'       => 'christmas_slide2_title2',
                'type'     => 'text',
                'title'    => __('Main Title Line 2', 'greenleaf_theme_options'),
                'default'  => 'HANGING BASKET'
            ),
            array(
                'id'       => 'christmas_slide2_title3',
                'type'     => 'text',
                'title'    => __('Main Title Line 3', 'greenleaf_theme_options'),
                'default'  => 'RANGE'
            ),
            ...
            array(
                'id'       => 'christmas_slide2_button_link',
                'type'     => 'text',
            ...
            /* ********* Slide 3 start ********* */
            array(
                'id' => 'christmas-slide3-section-start',
                'type' => 'section',
            ...
            array(
                'id'       => 'christmas_slide3_tab',
                'type'     => 'text',
                'title'    => __('Tab Text for slide 3', 'greenleaf_theme_options'),
                'default'  => 'Outdoor Christmas lighting'
            ),
            array(
                'id'       => 'christmas_slide3_title_small',
                'type'     => 'text',
                'title'    => __('Small Title for slide 3', 'greenleaf_theme_options'),
                'default'  => 'Outdoor Christmas lighting'
            ),
            array(
                'id'       => 'christmas_slide3_title1',
                'type'     => 'text',
                'title'    => __('Main Title Line 1', 'greenleaf_theme_options'),
                'default'  => 'NEW SUMMER'
            ),
            array(
                'id'       => 'christmas_slide3_title2',
                'type'     => 'text',
                'title'    => __('Main Title Line 2', 'greenleaf_theme_options'),
                'default'  => 'HANGING BASKET'
            ),
            array(
                'id'       => 'christmas_slide3_title3',
                'type'     => 'text',
                'title'    => __('Main Title Line 3', 'greenleaf_theme_options'),
                'default'  => 'RANGE'
            ),
            ...
            array(
                'id'       => 'christmas_slide3_button_link',
                'type'     => 'text',
            ...
            /* ********* Slide 4 start ********* */
            array(
                'id' => 'christmas-slide4-section-start',
                'type' => 'section',
            ...
            array(
                'id'       => 'christmas_slide4_tab',
                'type'     => 'text',
                'title'    => __('Tab Text for slide 4', 'greenleaf_theme_options'),
                'default'  => 'Christmas Bauble Bowls'
            ),
            array(
                'id'       => 'christmas_slide4_title_small',
                'type'     => 'text',
                'title'    => __('Small Title for slide 4', 'greenleaf_theme_options'),
                'default'  => 'Christmas Bauble Bowls'
            ),
            array(
                'id'       => 'christmas_slide4_title1',
                'type'     => 'text',
                'title'    => __('Main Title Line 1', 'greenleaf_theme_options'),
                'default'  => 'NEW SUMMER'
            ),
            array(
                'id'       => 'christmas_slide4_title2',
                'type'     => 'text',
                'title'    => __('Main Title Line 2', 'greenleaf_theme_options'),
                'default'  => 'HANGING BASKET'
            ),
            array(
                'id'       => 'christmas_slide4_title3',
                'type'     => 'text',
                'title'    => __('Main Title Line 3', 'greenleaf_theme_options'),
                'default'  => 'RANGE'
            ),
            ...
            array(
                'id'       => 'christmas_slide4_button_link',
                'type'     => 'text',
            ...
            /* ********* Inner Page Links ******** */
            array(
                'id' => 'christmas-inner-pages-start',
                'type' => 'section',
                'title' => __('Inner Page Links', 'greenleaf_theme_options'),
                'indent' => true
            ),
            array(
                'id'          => 'christmas_page_page_links',
                'type'        => 'slides',
            ...
            /* ********* INTERIOR PLANTING ******** */
            array(
                'id' => 'christmas-planting-start',
                'type' => 'section',
                'title' => __('Interior Planting Section', 'greenleaf_theme_options'),
                'indent' => true
            ),
            array(
                'id'=>'christmas-planting-text',
                'type' => 'textarea',
                'title' => __('christmas Planting Section Content', 'greenleaf_theme_options'),
