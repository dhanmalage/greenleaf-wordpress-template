        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 no-padding-right">
            <div class="inner-page-checklist-wrapper">
                ...
                <div class="buttons">
                    ...
                    <a href="<?php echo get_permalink( get_page_by_path( 'download-brochure-outdoor' ) ); ?>" class="download-brochure">Download brochure</a>
                </div>
...
<div class="container">
    <div class="row-fluid">
        ...
        <?php
        $args = array( 'post_type' => 'product', 'posts_per_page' => 16, 'product_cat' => 'winter-hanging-baskets', 'orderby' => 'rand' );
        $loop = new WP_Query( $args );
        while ( $loop->have_posts() ) : $loop->the_post(); global $product; ?>

            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 hanging-basket-product-wrapper">
                <div class="row">

                    <div class="col-md-12">

                        <a class="hanging-basket-title-link" href="<?php echo get_permalink( $loop->post->ID ) ?>" title="<?php echo esc_attr($loop->post->post_title ? $loop->post->post_title : $loop->post->ID); ?>">

                            <h3 class="summer-basket-product-title"><?php the_title(); ?></h3>

                        </a>

                    </div>

                    <div class="col-xs-12 col-sm-12 col-md-12 hanging-basket-main-img-wrap">
                        <?php $img_url = $image = wp_get_attachment_image_src( get_post_thumbnail_id( $loop->post->ID ), 'single-post-thumbnail' );?>
                        <div class="summer-basket-product-image">
							<a href="javascript:;" data-toggle="modal" data-target="#product-enquire-now" productid="<?php echo $product->id; ?>" class="product-enq-btn">
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="summer-basket-order-btn">
                            <!-- <a href="<?php // echo get_permalink( $loop->post->ID ) ?>">Order Now</a> -->
							<a href="javascript:;" data-toggle="modal" data-target="#product-enquire-now" productid="<?php echo $product->id; ?>" class="product-enq-btn">Enquire Now</a>	
                        </div>
                    </div>
