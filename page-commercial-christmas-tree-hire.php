<?php
/**
 * Template Name: Cristmas Tree Hire
 *
 * @package WordPress
    ...
    <div class="row-fluid">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 no-padding-right">
            <div class="inner-page-checklist-wrapper">
                ...
                <div class="buttons">
				<?php $buttons = get_field('button_conditions'); ?>
				...
				<?php if( $buttons && in_array('download', $buttons) ): ?>
                    <a href="<?php echo get_field('brochure_page_url'); ?>" class="download-brochure" <?php if( $buttons && in_array('brochure', $buttons) ): ?>target="_blank"<?php endif; ?>>Download brochure</a>
				<?php endif; ?>
                </div>
        ...
        <div class="col-xs-12 col-sm-8 disigner-range-experience-wrap-left">
            ...
            if ( have_posts() ) {
                while ( have_posts() ) {
                    the_post();
            ?>
            <div class="content-read-more custom-template">
...
<div class="container">
    <div class="row-fluid">
		<?php
			if( have_rows('custom_template_bottom_buttons') ):
				while ( have_rows('custom_template_bottom_buttons') ) : the_row();
		?>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-padding-left no-padding-right">
            <div class="hanging-baskets-bottom-image-wrapper">
               <a href="<?php the_sub_field('button_link'); ?>">
                    <div class="summer-hanging-basket-image" style="background-image: url('<?php the_sub_field('button_image'); ?>')">
                        <h3><?php the_sub_field('button_title'); ?></h3>
                    </div>
               </a>
            </div>
        </div>
