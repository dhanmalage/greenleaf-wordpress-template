    ...
    <div class="row-fluid">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding-left no-padding-right">
			<div class="promo-main-content">               
				...
				<a href="javascript:;" data-toggle="modal" data-target="#download">download now</a>				
            </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title promo-modal-title">Download our Christmas Tree Hire guide to enjoy a stress free Christmas!</h4>
      </div>
      <div class="modal-body">
		<div id="status"></div>
        <div id="promoDownloadForm" class="row">
		
		<?php echo do_shortcode('[contact-form-7 id="985" title="Promotion Download"]'); ?>
<!--		
			<div class="col-xs-12 form-group">
				<input id="fullName" class="form-control" type="text" placeholder="Full Name" />
			</div>
			<div class="col-xs-12 form-group">
				<input id="telephone" class="form-control" type="text" placeholder="Telephone" />
			</div>
			<div class="col-xs-12 form-group">
				<input id="email" class="form-control" type="text" placeholder="Email" />
			</div>
			<div class="col-xs-12 form-group promo-submit">
				<a href="javascript:;" id="promoDownloadSubmit">ok</a>
			</div>
-->
		</div>
      </div>
